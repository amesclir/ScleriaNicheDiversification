...
#printing results
char.p <- seq(12,132)
lambda.d.h.c <- noroptimal.x(char.p, bio1.mle.d.h.c$par[1], bio1.mle.d.h.c$par[2], bio1.mle.d.h.c$par[3], bio1.mle.d.h.c$par[4])
plot(char.p, lambda.d.h.c, type = "l")
lambda.d.c.c <- constant.x(char.p, bio1.mle.d.c.c$par[1])
plot(char.p, lambda.d.c.c, type = "l")
lambda.d.s.c <- sigmoid.x(char.p, bio1.mle.d.s.c$par[1], bio1.mle.d.s.c$par[2], bio1.mle.d.s.c$par[3], bio1.mle.d.s.c$par[4])
plot(char.p, lambda.d.s.c, type = "l")
lambda.d.l.c <- linear.x(char.p, bio1.mle.d.l.c$par[1], bio1.mle.d.l.c$par[2])
plot(char.p, lambda.d.l.c, type = "l")
lambda.h.c <- noroptimal.x(char.p, bio1.mle.h.c$par[1], bio1.mle.h.c$par[2], bio1.mle.h.c$par[3], bio1.mle.h.c$par[4])
plot(char.p, lambda.h.c, type = "l")
lambda.c.c <- constant.x(char.p, bio1.mle.c.c$par[1])
plot(char.p, lambda.c.c, type = "l")
lambda.s.c <- sigmoid.x(char.p, bio1.mle.s.c$par[1], bio1.mle.s.c$par[2], bio1.mle.s.c$par[3], bio1.mle.s.c$par[4])
plot(char.p, lambda.s.c, type = "l")
lambda.l.c <- linear.x(char.p, bio1.mle.l.c$par[1], bio1.mle.l.c$par[2])
